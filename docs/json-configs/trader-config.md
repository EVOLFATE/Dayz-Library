...
## Introduction
### What is Trader Config?
Trader Config is an important aspect of DayZ modding that allows you to enhance your server and create unique gameplay experiences.

### Why Use Trader Config?
- Enhances gameplay
