...
## Overview
Interactive maps and navigation tools help players explore the DayZ world.
...
Territory Planning is an important aspect of DayZ modding that allows you to enhance your server and create unique gameplay experiences.

### Why Use Territory Planning?
- Enhances gameplay
