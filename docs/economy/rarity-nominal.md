...
## Overview
The central economy system controls loot spawning, distribution, and persistence in DayZ.
...
## Introduction
### What is Rarity Nominal?
Rarity Nominal is an important aspect of DayZ modding that allows you to enhance your server and create unique gameplay experiences.

### Why Use Rarity Nominal?
- Enhances gameplay
