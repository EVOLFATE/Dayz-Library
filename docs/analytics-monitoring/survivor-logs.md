...
## Introduction
### What is Survivor Logs?
Survivor Logs is an important aspect of DayZ modding that allows you to enhance your server and create unique gameplay experiences.

### Why Use Survivor Logs?
- Enhances gameplay
